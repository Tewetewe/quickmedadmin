...
import com.example.adminquickmed.datafiles.Message;
import com.example.adminquickmed.datafiles.MessageAdapter;
import com.example.adminquickmed.datafiles.MessageAdapter.MessageHolder;
...
public class KonsultasiActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("KonsultasiActivity", " this os onCreate: " + user);

        //Check if user has signed in before else redirect to login page
        if(user==null){
            startActivity(new Intent(this, LoginChatActivity.class));
            finish();
            return;
        }
        ...
        adapter = new MessageAdapter(query, userId, KonsultasiActivity.this);
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.btnSend){
            ...
            if(TextUtils.isEmpty(message)){
                Toast.makeText(KonsultasiActivity.this, "Post is post", Toast.LENGTH_LONG).show();
                return;
            }
