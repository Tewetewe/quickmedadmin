        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UPLOAD_URL,
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if (success == 1) {
                            ...
                            Toast.makeText(UploadImageActivity.this, jObj.getString(TAG_MESSAGE), Toast.LENGTH_LONG).show();
            ...
            new Response.ErrorListener() {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    //menampilkan toast
                    Toast.makeText(UploadImageActivity.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
