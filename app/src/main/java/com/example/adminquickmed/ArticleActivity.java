...
public class ArticleActivity extends AppCompatActivity {
    ...
    private String UPLOAD_URL = "https://quickmedapi.000webhostapp.com/uploadArtikel.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_judul = (EditText) findViewById(R.id.et_judul);
        txt_isi = (EditText) findViewById(R.id.et_isi);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UPLOAD_URL,
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if (success == 1) {
                            ...
                            Toast.makeText(ArticleActivity.this, jObj.getString(TAG_MESSAGE), Toast.LENGTH_LONG).show();
            ...
            new Response.ErrorListener() {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    //menampilkan toast
                    Toast.makeText(ArticleActivity.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(KEY_JUDUL, txt_judul.getText().toString().trim());
                params.put(KEY_ISI, txt_isi.getText().toString().trim());
